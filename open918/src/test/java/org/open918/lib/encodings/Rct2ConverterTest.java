...
public class Rct2ConverterTest {
    ...
    public void testToTicketDetailsNSEticket() throws Exception {
        ...
        Ticket918Dash3 s = (Ticket918Dash3) TicketUtils.getTicket(ticket);
        assertEquals(TicketStandard.TICKET918_3, s.getStandard());
        System.out.println("Got "+s.getRicsCode()+"-"+s.getSignatureKeyId());
